...
namespace word_unscrambler.Test.Unit
{
    ...
    public class WordMatcherTest
    {
        ...
        public readonly WordMatcher _wordMatcher = new WordMatcher();

        [TestMethod]
        public void ScrambkedWordMatchesGivenWordInTheList()
        {
        ...
        [TestMethod]
        public void ScrambkedWordMatchesGivenWordsInTheList()
        {
            string[] words = { "cat", "chair", "more" };
